...
const sections = [
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'Tabs de navegación: Appointments, Owners, Properties, Clients, Calendar',
          'Páginas de gestión dedicadas: /admin/owners y /admin/properties',
          'Notificaciones con campana y contador',
          'Actualización en tiempo real vía WebSocket (ws://localhost:3000/ws)',
        ],
      },
      {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'Expirado después de 24 horas (configurable)',
          'Todos los endpoints admin requieren Bearer token',
          'También autentica la conexión WebSocket (?token= en /ws)',
        ],
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        subtitle: 'Gestión en el Panel',
        items: [
          'Página dedicada: /admin/owners',
          'Formulario completo de creación y edición',
          'Muestra número de propiedades por propietario',
          'Enlace directo a las propiedades del propietario (/admin/properties?ownerId=...)',
        ],
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        subtitle: 'Gestión en el Panel',
        items: [
          'Página dedicada: /admin/properties',
          'Formulario completo de creación y edición',
          'Filtro por propietario (ownerId)',
          'Acceso desde la pestaña Properties o desde un propietario',
        ],
      },
      {
    ...
    content: [
      {
        ...
        items: [
          ...
          'POST /api/appointments/:id/cancel - Cancelar (admin, libera slot y notifica cliente)',
      ...
      {
        subtitle: 'Acciones sobre Citas',
        items: [
          'Cancelar - Libera el slot, notifica al cliente y emite evento WebSocket',
          'Eliminar - Borrado permanente de la cita',
          'Ambas acciones con diálogo de confirmación',
          'Las citas canceladas no muestran el botón Cancelar',
        ],
      },
    ],
  },
    ...
    content: [
      {
        ...
        items: [
          ...
          'POST /api/calendar/block/:id?date=&type= - Bloquear todo el día (admin)',
          'POST /api/calendar/custom-slots - Crear slots personalizados (admin)',
          'GET /api/calendar/month?startDate=&endDate= - Slots del mes (admin)',
          'GET /api/calendar/available-days/:id?startDate=&endDate= - Días con slots (público)',
        ],
      },
      {
      ...
      },
      {
        subtitle: 'Vista Mes',
        items: [
          'Días con color según disponibilidad (verde/amarillo/rojo/gris)',
          'Bloques RESERVADOS muestran rango horario y dirección de la propiedad',
          'Click en un día abre la vista día',
          'Resumen "Slots by Property" con conteos por tipo en cada propiedad',
        ],
      },
      {
        subtitle: 'Vista Día',
        items: [
          'Selector de propiedad y fecha',
          'Acciones rápidas: todo el día Available / Reserved / Blocked',
          'Crear slots personalizados (hora inicio, hora fin, duración, tipo)',
          'Click en un slot para ciclar su tipo: AVAILABLE → RESERVED → BLOCKED',
          'Eliminar slots individualmente',
        ],
      },
      {
        subtitle: 'Formato de Fechas',
        items: [
          'Internamente las fechas se manejan como DD-MM-YYYY',
          'El backend recibe DD-MM-YYYY vía toBackend()',
          'El frontend convierte a ISO (YYYY-MM-DD) con toFrontend()',
          'Las horas son strings HH:mm',
        ],
      },
    ],
  },
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'Contador de no leídas en tiempo real (WebSocket)',
          'Evento admin:notification actualiza la lista al instante',
          'Polling de respaldo cada 30 segundos',
          'Panel desplegable al hacer clic; click en una notificación la marca como leída',
        ],
      },
    ],
  },
    ...
    content: [
      {
        subtitle: 'Conexión',
        items: [
          'URL: ws://localhost:3000/ws (wss:// en producción)',
          'Autenticación: JWT token del admin vía query param ?token=',
          'Conexión rechazada (401) si el token es inválido o expirado',
          'Heartbeat cada 30 segundos para detectar clientes inactivos',
          'El frontend reconecta automáticamente con backoff exponencial',
        ],
      },
      {
        subtitle: 'Eventos',
        items: [
          'admin:notification - Nueva notificación para el admin',
          'appointment:created - Cita creada (booking)',
          'appointment:updated - Cita actualizada',
          'appointment:cancelled - Cita cancelada',
          'appointment:confirmed - Cliente confirmó asistencia',
          'appointment:reminder - Recordatorio enviado por el cron',
          'property:updated - Propiedad creada/actualizada/eliminada',
          'slot:updated - Slot de calendario modificado',
        ],
      },
      {
        subtitle: 'Efecto en el Panel',
        items: [
          'El panel admin se refresca automáticamente al recibir eventos',
          'El contador de notificaciones se incrementa en tiempo real',
          'Los datos de citas, propiedades y slots se recargan sin recargar la página',
          'Si la conexión cae, el poll cada 30 s actúa como respaldo',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      {
        subtitle: 'Paso a Paso (Asistente de 4 Pasos)',
        items: [
          '1. Cliente visita / o /properties (público)',
          '2. Selecciona una propiedad',
          '3. Click en "Agendar Cita"',
          '4. Paso 1: Elige una fecha disponible en el calendario mensual',
          '5. El calendario solo muestra días con slots libres (available-days)',
          '6. Paso 2: Elige uno de los horarios disponibles',
          '7. Paso 3: Llena el formulario con datos personales',
          '8. Paso 4: Revisa y confirma la reserva',
          '9. Sistema busca/crea cliente por email (find-or-create)',
          '10. Crea cita con estado PENDING (duración 15 min)',
          '11. Se muestra pantalla de éxito con resumen de la cita',
          '12. El cron generará el token y enviará el recordatorio 30 min antes',
        ],
      },
      {
        ...
        items: [
          ...
          'Slot debe estar disponible al momento de reservar',
          'No puede haber cita duplicada en el mismo horario/cliente',
      ...
      },
      {
        ...
        items: [
          ...
          '/booking/[id] - Asistente de booking (4 pasos)',
          '/confirm/[token] - Confirmación pública de la cita',
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          'Verificar sesión iniciada (WebSocket requiere JWT)',
          'Revisar logs del backend para "WebSocket server initialized on /ws"',
          'Verificar NEXT_PUBLIC_API_URL apunta al origen correcto (el WS deriva de ahí)',
          'La campana consume además un poll cada 30 segundos como respaldo',
